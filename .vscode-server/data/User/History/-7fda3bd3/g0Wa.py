...
class CustomObject:
    ...
    def serialize(self, filename):
        """
        Sérialise l'objet courant dans
        un fichier spécifié en utilisant le module pickle.
    ...
    def deserialize(cls, filename):
        """
        Désérialise un objet à partir d'un fichier en
        utilisant le module pickle.
