...
class Voiture(Vehicule):
    ...
    def se_deplacer(self):
        print("Je roule sur la voix de gauche normal j'ai une {} !!!".format(self.nom))
...
class Moto(Vehicule):
    ...
    def se_deplacer(self):
        print("Je leve le {} en y".format(self.nom))

v1 = Moto("Tracer 700", "75 ch", "Arrow")
v2 = Voiture("m5 will sedan", "1200 ch", 5)
v1.se_deplacer()
print("le sacre bruit est a cause du pot {}".format(v1.pot))
v2.se_deplacer()
print(v2.chevaux)